...
footnotes:
  [
    {
      id: "footnote-1",
      text: "A McCulloch et al. (2014) The impact of work experience on student outcomes: implications for policy and practice. HECSU.",
    },
    {
      id: "footnote-2",
      text: "Claire Callender. (2008) The impact of term-time employment on higher education students’ academic attainment and achievement. Journal of Education Policy. Volume 1: Issue 4.",
    },
    {
      id: "footnote-3",
      text: "Paul Greenbank and Sue Hepworth. (2008). Working class students and the career decision-making process: a qualitative study. HECSU.",
    },
  ]
...
selective universities.<FootnoteLink linkId="footnote-1">1</FootnoteLink>
...
to entry.<FootnoteLink linkId="footnote-2">2</FootnoteLink> The more students
...
their beliefs and values.<FootnoteLink linkId="footnote-3">3</FootnoteLink> They
...
(also explored in the section Participation in extra-curricular activities and
work experience) that students from lower socio-economic background are more
unfamiliar with the ‘rules of the game’.