...
import GraphLegend, { LegendVariant } from "../../components/research/graph-legend";
import LabelGraphPair from "../../components/research/label-graph-pair";
import FamilyCircumstancesGraphPart1Mobile from "./svg/family-circumstances-graph-1-mobile.svg"
import FamilyCircumstancesGraphPart2Mobile from "./svg/family-circumstances-graph-2-mobile.svg"
import FamilyCircumstancesGraphPart3Mobile from "./svg/family-circumstances-graph-3-mobile.svg"
import FamilyCircumstancesGraphPart4Mobile from "./svg/family-circumstances-graph-4-mobile.svg"
import FamilyCircumstancesGraphPart5Mobile from "./svg/family-circumstances-graph-5-mobile.svg"
import FamilyCircumstancesGraphPart6Mobile from "./svg/family-circumstances-graph-6-mobile.svg"
import FamilyCircumstancesGraphPart7Mobile from "./svg/family-circumstances-graph-7-mobile.svg"
import FamilyCircumstancesGraphPart1Desktop from "./svg/family-circumstances-graph-1-desktop.svg"
import FamilyCircumstancesGraphPart2Desktop from "./svg/family-circumstances-graph-2-desktop.svg"
import FamilyCircumstancesGraphPart3Desktop from "./svg/family-circumstances-graph-3-desktop.svg"
import FamilyCircumstancesGraphPart4Desktop from "./svg/family-circumstances-graph-4-desktop.svg"
import FamilyCircumstancesGraphPart5Desktop from "./svg/family-circumstances-graph-5-desktop.svg"
import FamilyCircumstancesGraphPart6Desktop from "./svg/family-circumstances-graph-6-desktop.svg"
import FamilyCircumstancesGraphPart7Desktop from "./svg/family-circumstances-graph-7-desktop.svg"
...
attainment.<FootnoteLink text="5"/> In particular,
parental engagement has a striking effect on reading in the early years and
throughout primary school. Parental actions such as reading to a child, or being
read to, can have a strong impact on a child’s reading progress and life-long
enjoyment of reading. Parents who make time for reading and promote it at home —
through library visits and reading routines — are more likely to inspire
motivation to read. Correspondingly, reading ability is a strong predictor of
attainment.
...
<Footnotes>
  1. Lorraine Dearden et al. (2011). The socio-economic gradient in early child outcomes: evidence from the millennium cohort study. Longitudinal and life course studies. Volume 2: Issue 1.
  2. NatCen Social Research. Can out of school activities close the education gap?; Donnelly (2019) An Unequal Playing Field
  3. Michael Donnelly et al. (2019) An Unequal Playing Field: Extra-Curricular Activities, Soft Skills and Social Mobility. Social Mobility Commission.
  4. William Jeynes. (2010) Parental Involvement and Academic Success. Taylor & Francis.
  5. Desforges, C. and Abouchaar, A. (2003). The impact of parental involvement, parental support and family education on pupil achievement and adjustment: A literature review. London: Department for Education and Skills.
</Footnotes>