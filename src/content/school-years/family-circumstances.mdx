...
<div className="full-span">
  ### Which of the following have you ever done for your child(ren) to get into a school?

  <GraphLegend
    labels={[
      { color: "red-gradient-1", label: "Higher managerial, administrative and professional" },
      { color: "red-gradient-2", label: "Intermediate managerial, administrative and professional" },
      { color: "red-gradient-3", label: "Supervisory, clerical and junior managerial, administratice and professional" },
      { color: "red-gradient-4", label: "Skilled manual workers" },
      { color: "red-gradient-5", label: "Semi-skilled and unskilled manual workers" },
      { color: "red-gradient-6", label: "State pensioners, casual and lowest grade workers, unemployed with state benefits only" },
    ]}
    forceVertical={true}
    variant={LegendVariant.BRICK}
  />

  <LabelGraphPair
    label="Moved to live in an area which I thought had good schools"
    mobileGraph={FamilyCircumstancesGraphPart1Mobile}
    tabletGraph={FamilyCircumstancesGraphPart1Desktop}
    desktopGraph={FamilyCircumstancesGraphPart1Desktop}
  />
  <LabelGraphPair
    label="Appealed against a decision allocating my child(ren) to a specific school"
    mobileGraph={FamilyCircumstancesGraphPart2Mobile}
    tabletGraph={FamilyCircumstancesGraphPart2Desktop}
    desktopGraph={FamilyCircumstancesGraphPart2Desktop}
  />
  <LabelGraphPair
    label="Moved to live in the catchment area of a specific school"
    mobileGraph={FamilyCircumstancesGraphPart3Mobile}
    tabletGraph={FamilyCircumstancesGraphPart3Desktop}
    desktopGraph={FamilyCircumstancesGraphPart3Desktop}
  />
  <LabelGraphPair
    label="Attended religious services to that my child(ren) could enter a religious school"
    mobileGraph={FamilyCircumstancesGraphPart4Mobile}
    tabletGraph={FamilyCircumstancesGraphPart4Desktop}
    desktopGraph={FamilyCircumstancesGraphPart4Desktop}
  />
  <LabelGraphPair
    label="Employed a private tutor to help my child(ren) pass the entrance test for a particular school"
    mobileGraph={FamilyCircumstancesGraphPart5Mobile}
    tabletGraph={FamilyCircumstancesGraphPart5Desktop}
    desktopGraph={FamilyCircumstancesGraphPart5Desktop}
  />
  <LabelGraphPair
    label="Bought/rented a second home and used that address in order for my child(ren) to gain access to a particular school"
    mobileGraph={FamilyCircumstancesGraphPart6Mobile}
    tabletGraph={FamilyCircumstancesGraphPart6Desktop}
    desktopGraph={FamilyCircumstancesGraphPart6Desktop}
  />

  <LabelGraphPair
    label="Used a relative’s address in order for my child(ren) to gain access to a specific school"
    mobileGraph={FamilyCircumstancesGraphPart7Mobile}
    tabletGraph={FamilyCircumstancesGraphPart7Desktop}
    desktopGraph={FamilyCircumstancesGraphPart7Desktop}
  />
</div>
