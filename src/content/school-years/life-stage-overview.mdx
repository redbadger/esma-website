...
description: The gap in attainment between pupils from higher and lower socio-economic backgrounds grows wider at every stage of education.
---
...
weak educational outcomes, such as <a className="external-link"
