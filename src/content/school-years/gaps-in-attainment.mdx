...
import GapsInGCSEAttainmentStandardDesktop from "./svg/school-years-gaps-in-gcse-attainment-graph-1-desktop.svg";
import GapsInGCSEAttainmentStandardMobile from "./svg/school-years-gaps-in-gcse-attainment-graph-1-mobile.svg";
...
<div className="full-span common-legend">
  ...
  <GraphLegend
    labels={[
      { color: "yellow", label: "Disadvantaged pupils" },
      { color: "cobalt", label: "All other pupils" },
    ]}
  />
</div>
...
<ResizableGraph
  mobile={GapsInGCSEAttainmentStandardMobile}
  tablet={GapsInGCSEAttainmentStandardDesktop}
  desktop={GapsInGCSEAttainmentStandardDesktop}
  fullSpan={false}
>
...
<Footnotes>
  ...
  9. <a href="https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/863815/2019_KS4_revised_text.pdf">https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/863815/2019_KS4_revised_text.pdf</a>
</Footnotes>
