...
footnotes:
  [
    ...
    {
      id: "footnote-3",
      text: "Jani Erola et al. (2016) Parental education, class and income over early life course and children’s achievement. Research in Social Stratification and Mobility. 44.",
    },
  ]
---
...
achievement, parental education has the strongest effect<FootnoteLink linkId="footnote-3">3</FootnoteLink>. It means it has a key
