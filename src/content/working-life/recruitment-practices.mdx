...
footnotes:
  [
    ...
    {
      id: "footnote-4",
      text: "Steven Jones. (2020) Might selective English universities now wean
...
universities with high tariff
entrants<FootnoteLink linkId="footnote-4">4</FootnoteLink>. Little is currently
done to measure institutions that offer ‘value added’ to their students (i.e.
outcomes relative to input).
