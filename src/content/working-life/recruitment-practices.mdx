...
efforts amongst the least diverse populations, as illustrated in the figure
below: those institutions (each is represented by a dot below) that have most
visits from leading employer are those with least socio-economic diversity.
