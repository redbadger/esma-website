...
diversity in recruitment. <FootnoteLink text="2"/>
...
universities with high tariff entrants<FootnoteLink text="4"/>. Little is currently done to measure
...
<div>
  ...
  #### Methods used by employers to screen candidates applications (ISE 2018) <FootnoteLink text="5"/>
...
<div>
  ...
  potential over previous experiences. <FootnoteLink text="6"/>
