...
footnotes:
  [
    ...
    {
      id: "footnote-2",
      text: "Bridge Group. (2018) Socio-economic background and early career progression in the law.",
    },
    {
      id: "footnote-3",
      text: "Bridge Group. (2018) Socio-economic background and early career progression in the law.",
    ...
    {
      id: "footnote-4",
      text: "Sam Friedman and Daniel Laurison. (2015) Introducing the ‘class’ ceiling. LSE.",
    },
    {
      id: "footnote-5",
      text: "Philip Kirby. Leading people 2016: The educational backgrounds of the UK professional elite. The Sutton Trust.",
    },
    {
      id: "footnote-6",
      text: "Sam Friedman and Daniel Laurison. (2020) The class ceiling: why it pays to be privileged. Policy Press.",
    },
  ]
---
...
○	dominant work cultures that
have been historically shaped by white affluent males and which thereby
advantage those from these backgrounds;

○	employers’ relatively narrow
definitions of ‘talent’ (including a strong emphasis placed on extraversion and
confidence, sometimes over competence); sponsored mobility (supporting people in
one’s own image);

○	client perceptions and preferences; and the collective and
perpetuating effects of these dynamics on work allocation and performance
management.
</div>
